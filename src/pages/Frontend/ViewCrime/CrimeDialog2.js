...
function CrimeDialog({mapRef,index=0,onClose}) {
  ...
  const data = values && CrimeDetails(values,index,vehicle_theft_choices,various_choices,mediaData,reportType);
  return (
                          ...
                          <TableBody>
                            {data.map((row, index) => {
                              ...
                              {typeof(row.secondCol) === "object" && <TableRow key={index}>
                                ...
                                {row.firstCol == "Description" &&  <TableCell>{row.firstCol}</TableCell>}
                                ...
                                {row.firstCol == "Media" &&  <TableCell>{row.firstCol}</TableCell>}
                                ...
                                {row.firstCol == "Description" &&  <TableCell>
                                  row.secondCol
                                </TableCell>}
